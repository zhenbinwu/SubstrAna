...
int main (int argc, char ** argv) {
  ...
  if (argc < 6) {
    ...
    cout << "Usage: MiniNtuplizer <inputFilesList> <maxevents> <outputfile> <coneSize> <analyze PF CMSSW jets>" <<endl;
    cout << "Example: MiniNtuplizer input.txt 100 outtree.root 0.8 0"<<endl;
    exit(0);
  }
